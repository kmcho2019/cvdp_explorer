...
All project documentation is consolidated in this `docs/` directory.
...
- New to the repo:
  ...
  - `ARCHITECTURE.md`
- Working on preprocessing/data shape:
  - `DATA_PIPELINE.md`
- Working on UI/UX and rendering:
  - `FRONTEND.md`
...
- `SPECIFICATION_AND_DEVELOPMENT_PLAN.md`: implementation blueprint and phased roadmap.
- `ARCHITECTURE.md`: high-level system architecture and repository layout.
...
- `TESTING_AND_CI.md`: uv-based Python checks, test matrix, local commands, CI expectations, and quality checklist.
